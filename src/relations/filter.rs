...
//                            let filtered_columns: Vec<Rc<Array>> = (0..batch.num_columns())
...
//
//                            let filtered_batch: Rc<RecordBatch> = Rc::new(RecordBatch {
//                                num_rows: row_count,
...
pub fn filter(column: &Rc<Array>, bools: &Array) -> Array {
    unimplemented!()
}
    //println!("filter()");
//    match column {
